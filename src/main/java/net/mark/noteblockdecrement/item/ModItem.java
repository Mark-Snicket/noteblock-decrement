...
public class ModItem {
    ...
    private static Item registerItem(Function<Item.Properties, Item> function) {
        return Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(NoteblockDecrement.MOD_ID, "noteblock_decrementer"),
                function.apply(new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(NoteblockDecrement.MOD_ID, "noteblock_decrementer")))));
    }
